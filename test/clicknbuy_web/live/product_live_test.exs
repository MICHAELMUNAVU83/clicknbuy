defmodule ClicknbuyWeb.ProductLiveTest do
  use ClicknbuyWeb.ConnCase

  import Phoenix.LiveViewTest
  import Clicknbuy.ProductsFixtures

  @create_attrs %{name: "some name", position: 42, status: "some status", description: "some description", slug: "some slug", base_price: 42, badge_label: "some badge_label", badge_color: "some badge_color", is_featured: true, is_bestseller: true, is_new_arrival: true}
  ...
  @invalid_attrs %{name: nil, position: nil, status: nil, description: nil, slug: nil, base_price: nil, badge_label: nil, badge_color: nil, is_featured: false, is_bestseller: false, is_new_arrival: false}
