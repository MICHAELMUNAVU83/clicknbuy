defmodule ClicknbuyWeb.TestimonialLive.Index do
  ...
  def mount(_params, _session, socket) do
    {:ok,
     ...
     |> stream(:testimonials, Testimonials.list_testimonials())}
  end
  ...
  def render(assigns) do
    ...
    <div class="overflow-hidden rounded-xl border border-gray-100 bg-white shadow-sm">
      ...
      <div class="overflow-x-auto">
        <table class="w-full">
          ...
          <tbody id="testimonials" phx-update="stream">
            <tr
            ...
            >
              ...
              <td class="px-5 py-3.5 max-w-xs">
                <p class="line-clamp-2 text-sm text-gray-500">"{t.body}"</p>
              </td>
              ...
              <td class="px-5 py-3.5">
                <span class={[
                  ...
                  <span class={[
                    ...
                    if(t.is_active, do: "bg-green-500", else: "bg-gray-400")
                  ]} />
              ...
              <%!-- Position --%>
              <td class="px-5 py-3.5">
                <span class="text-sm text-gray-500">{t.position}</span>
              </td>
    ...
    <.modal
      ...
      show
      on_cancel={JS.patch(~p"/admin/testimonials")}
    >
      <.live_component
