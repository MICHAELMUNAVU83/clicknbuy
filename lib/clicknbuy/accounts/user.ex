defmodule Clicknbuy.Accounts.User do
  use Ecto.Schema
  ...
  def admin_invite_changeset(user, attrs) do
    user
    |> cast(attrs, [:email, :name, :password, :role])
    |> validate_email([])
    |> validate_password([])
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, Clicknbuy.Repo)
  ...
  """
  def valid_password?(%Clicknbuy.Accounts.User{hashed_password: hashed_password}, password)
